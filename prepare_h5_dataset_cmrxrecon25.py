...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_h5_folder', type=str,
                        default='/common/lidxxlab/cmrchallenge/task3/code/Lisha/datah5_debug-lisha/CMR2025/Processed/MultiCoil',
                        help='path to save H5 dataset')
    parser.add_argument('--input_matlab_folder', type=str,
                        default='/common/lidxxlab/cmrchallenge/data/CMR2025/ChallengeData/MultiCoil',
    ...
    if not args.symbol_only:
        for ff in tqdm(file_list):
            ...
            if ftype in ["T1w", "T2w", "blackblood"]:
                ...
                kdata = np.repeat(kdata, 2, axis=0) # why
            ...
            file.attrs['shape'] = kdata.shape # (Time), Slice, Coil (Combined), Weight, Height
            ...
            #########
            ## TO-DO: add more key info from the given info dictionary (FieldStrength, TR/TR/TI, and FLipAngle)
            file.close()
