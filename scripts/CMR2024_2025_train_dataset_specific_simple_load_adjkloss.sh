...
echo "Config File: $CMRROOT/configs/train/pmr-plus/cmr24-25-cardiac-task4-dataset-specific_xlk_adj.yaml"
echo ""
...
python main.py fit \
    -c $CMRROOT/configs/train/pmr-plus/cmr24-25-cardiac-task4-dataset-specific_xlk_adj.yaml \
    ...
    --model.init_args.num_adj_slices=5 \
    --model.init_args.kspace_loss_weight=0.01 \
    # --ckpt_path=/common/lidxxlab/Yi/training_results_folder/multi_dataset_training_kloss/promptmr-plus/CMR2024_2025_dataset_specific/cmr2024_2025_phased/d208mhbd/checkpoints/best-epochepoch=02-valvalidation_loss=0.0171.ckpt
