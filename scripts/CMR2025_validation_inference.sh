#!/bin/bash
#SBATCH --job-name=CMR_validation_inference
...
CMRROOT=/common/lidxxlab/chushu/PromptMR-plus-Task4_debug
#SAVE_DIR=/common/lidxxlab/chushu/TaskR2/val_bottleneck
...
python main.py predict \
      -c $CMRROOT/configs/inference/pmr-plus/cmr-task4-val_cs_with_sensmaps.yaml \
