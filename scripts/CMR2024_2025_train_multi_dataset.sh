...
echo "Config File: $CMRROOT/configs/train/pmr-plus/cmr24-25-cardiac-task3.yaml"
echo ""
...
# 创建保存目录
mkdir -p $SAVE_DIR/promptmr-plus/CMR2024_2025
echo "✓ Created save directory: $SAVE_DIR/promptmr-plus/CMR2024_2025"
echo ""

# 开始训练
echo "=== Starting Multi-Dataset Training ==="
echo "Training on CMR2024 + CMR2025 datasets"
echo "Model: PromptMR+ with multi-dataset support"
echo ""
...
python main.py fit \
    ...
    --trainer.logger.init_args.name=pmr_plus_cmr24_25_baseline \
    --trainer.logger.init_args.tags="[baseline, promptmr_plus, cmr24_25, multi_dataset]" \
...
echo "Results saved to: $SAVE_DIR/promptmr-plus/CMR2024_2025"
