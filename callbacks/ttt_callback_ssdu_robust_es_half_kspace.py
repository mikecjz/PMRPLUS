# callbacks/ttt_callback_ssdu_robust_es_half_kspace.py
import copy
    ...
    def setup(self, trainer, pl_module, stage: Optional[str] = None):
        if self.enable_wandb_logging:
            ...
            if self.wandb_logger is None:
                print("[TTT-HalfKSpace] WARNING: WandbLogger not found but enable_wandb_logging=True. Proceeding without W&B logging.")
        else:
            print("[TTT-HalfKSpace] W&B logging disabled by enable_wandb_logging=False")
